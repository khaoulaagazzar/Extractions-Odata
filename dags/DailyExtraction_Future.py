...
query="""select * from IBPExtractParametersV3 where Frequency="Daily" and tableType="FACT";"""
...
with DAG(
    ...
    for TargetName in df['TargetName'].unique():
        ...
        subdag=create_subdag('IBP_Daily_Future_DAG',f'extracting_{taskname}' , {'schedule_interval': None, 'start_date': datetime(2023, 5, 20)},TargetName,dataframe=df),
    dag=dag
    )
