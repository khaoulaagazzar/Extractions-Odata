...
with DAG(
    dag_id='IBP_Monthly_Future_DAG',
    schedule_interval='56 9 4 * *',
    ...
    for TargetName in df['TargetName'].unique():
        ...
        subdag=create_subdag('IBP_Monthly_Future_DAG',f'extracting_{taskname}' , {'schedule_interval': None, 'start_date': datetime(2023, 7, 6)},TargetName,dataframe=df),
    dag=dag
    )
