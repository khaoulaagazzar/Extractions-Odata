...
query="""select * from IBPExtractParametersV3 where Frequency="Monthly" and tableType="FACT";"""
...
with DAG(
    dag_id='IBP_Monthly_Past_DAG',
    schedule_interval='35 10 4 * *',
    ...
    for TargetName in df['TargetName'].unique():
        ...
        subdag=create_subdag('IBP_Monthly_Past_DAG',f'extracting_{taskname}' , {'schedule_interval': None, 'start_date': datetime(2023, 7, 3)},TargetName,dataframe=df),
    dag=dag
    )
